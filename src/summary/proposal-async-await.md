...
먼저 프로미스를 사용하여 작성된 다음 예를 살펴보겠습니다. 이 코드는 요소에 일련의 애니메이션을 연결하고, 애니메이션에 예외가 있을 때 중지하고, 성공적으로 실행된 최종 애니메이션에 의해 생성된 값을 반환합니다.
...
이미 프로미스가 있는 코드는 이러한 종류의 루프 및 예외 처리가 어려운 선형 콜백 스타일에서 훨씬 개선되었습니다.
